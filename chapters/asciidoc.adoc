...
Over time we expect more Khronos specifications will be published primarily
in Antora format, but we are still learning, and are not ready to recommend
Antora as the default publishing format yet.
