...
:docinfodir: {config}
:title-logo-image: image:{images}/{KhronosLogo}[top="25%"]
...
//     License Choices & Defaults
//         Proprietary spec license on ratified specs only
//     REUSE compliance
// Repository Structure
//     Boilerplate files & Contents
// Continuous Integration
//     Gitlab CI / Github Actions
//         REUSE compliance
//     Docker images, Khronos & other
// Github / Gitlab coexistence
//     Are both private & public repos needed?
//     Keeping repos synced
//     Keeping private content private (tags, commits, etc.)
// Github Management
//     CLA deployment
//     Public issue / PR responsiveness
//         Open issue
// Publication Strategies
//     When to publish
//     Generating PDF / HTML artifacts
//     In repository - only for simple markdown
//     In registries
//
// Specification Markup & Authoring
//     Choice of tools
//         Legacy - Word, LaTeX
//         Text Markup - Asciidoctor, Markdown
//             Simple use cases renderable from gitlab/github, but not in general
//         Other - raw HTML
//     Asciidoctor as Khronos default
//     Basic Asciidoctor toolchain
//         PDF / HTML options
//         Images
//         Math
//         Khronos default or custom Docker images
//     Custom Macros - Ruby extensions & offline processing
//     Complex toolchain w/API XML - refer to Vulkan / OpenXR
//         May be useful for C APIs
//         Talk to Jon / Ryan
//
//
...
// refer to could help:
//
// WG is new to asciidoctor and needs help with basic markup / toolchain issues
// - how to they install and run the tools locally, how do they use Khronos
// Docker images, where are the user guides for asciidoctor, and so on
//
